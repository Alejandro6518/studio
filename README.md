...
- `/`: Página de inicio con la propuesta y justificación ética.
- `/encuesta`: Formulario directo para la recolección de datos.
- `/resultado-de-encuesta`: Análisis estadístico y hallazgos clave del Grupo 4.

## Desarrollo
Este proyecto ha sido desarrollado como parte del curso de Ética, utilizando tecnologías modernas de desarrollo web para comunicar hallazgos sociales de manera clara y atractiva.
